...
def send_message():
    ...
    # 🔑 CONFIGURACIÓN DE OPENAI (COMPLETAR CON TUS DATOS)
    OPENAI_API_KEY = ""  # ← ¡COMPLETAR!
    ORGANIZATION_ID = ""  # ← ¡COMPLETAR!
    PROJECT_ID = ""       # ← ¡COMPLETAR!
    MODEL = "gpt-4"
    ...
    if not OPENAI_API_KEY:
        bot_response = "Error: No se ha configurado la clave de API de OpenAI."
    else:
        try:
